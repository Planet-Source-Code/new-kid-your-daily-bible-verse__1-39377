...
If Form1.Label1.Caption = "go" Then
If InStr(1, Text, "Today's passage", vbTextCompare) > 0 Then Form1.Label1.Caption = "no"
Form1.RichTextBox1.Text = Form1.RichTextBox1.Text & Text
End If
If InStr(1, Text, "Verse of the Day", vbTextCompare) > 0 Then
